...
from quest import Quiz  # Импортируем класс Quiz из модуля quiz1

from tree import greetings_generator1, greetings_generator2, start_generator, \
